...
#### שאילתא 1   - הסכום של רווח בריבעון של כל העובדים מטיפוס freelance


<img src="שלב_ג//query_1_view_1.jpg" width="700"/>   


#### שאילתא 2   -  משכורת חודשית של עובדים לפי חוזה שעתי כולל חישוב תוספת על אוברטיים (שעות נוספות)

<img src="שלב_ג//query_2_view_1.jpg" width="700"/>   



### מבט שני -  לוג של כל הכניסות ויציאות של כל המכשירים מכל סוגי האנשים

<img src="שלב_ג/view_2.png" width="700"/>  

#### שאילתא 1   -  כמות תיקונים למכשיר וגם כמה מתוכם דחופים
...
אחרי שהכניס משמרת
 ...
 <img src="שלב_ד//pictures//worker_after_shift_trigger.png" width="700"/>   


## תכניות ראשיות  
### תכנית א - מכניס משתמש ומחשב משכורת של עוד משתמש
#### הקוד 
...
$$ LANGUAGE plpgsql;
```
 <img src="שלב_ד//pictures//main_1.png" width="700"/>   




### תכנית ב - מעדכן ומעלה אזהרה  על כל חבר שפג החברות שלו וגם על כל תיקון שיש
#### הקוד
```
DO $$
DECLARE
